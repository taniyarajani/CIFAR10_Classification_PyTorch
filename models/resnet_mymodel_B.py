...
class MyModel(nn.Module):
    def __init__(self, hidden_dim, kernel_size, n_classes):
        ...
        #############################################################################
        self.conv1 = nn.Conv2d(64, hidden_dim, kernel_size, stride = 1, padding = 1)
        final_image_dim1 = self.compute_image_size((8,8), (kernel_size, kernel_size), 1, 1)
...
class Combine(nn.Module): 
    def __init__(self, hidden_dim, kernel_size, n_classes):
        ...
        self.model1= nn.Sequential(*list(self.model_resnet.children())[:-5])

        self.mymodel = MyModel(hidden_dim, kernel_size, n_classes)
    ...
    def forward(self, images):
        ...
        # commented as updating parameters    
        # with torch.no_grad():
